...
* We've learnt a lot since starting this project two years ago. Now the library is functionally stable we could do with rearchitecting the object structure and responsibilities. That's one of the reasons we've open sourced - hopefully we'll be embarrassed into having a long over due tidy up.
