...
QUEUE=tripod::development::apply,tripod::development::discover,tripod::apply,tripod::discover APP_INCLUDE=${BASH_SOURCE%/*}/worker.inc.php php ${BASH_SOURCE%/*}/${PATH_TO_RESQUE_BIN}/vendor/chrisboulton/php-resque/bin/resque